...
show_recent_cves() {
    ...
    echo ""
    # FIX: Replaced the final 'seq' command with a compatible 'while' loop and 'grep' pattern.
    # This resolves the 'seq: not found' error that was appearing in the summary line.
    local year_pattern=""
    local i=$start_year
